...
window.CARRYMATE_CONFIG = {
  ...
  appUrl: 'https://app.carrymate.thunivin.com/',
  repoUrl: '',
  ...
  hero: {
    eyebrow: 'Free · No middleman · Earn as you travel',
    headlineLine1: 'That empty suitcase',
    headlineEmphasis: 'space? Somebody needs it.',
    lede: "CarryMate matches travelers who have spare luggage space with people who need items delivered. "
        + "Whether you are traveling together on the same flight, or just handing off a package to a train traveler "
        + "headed your way, Paid as you Travel",
